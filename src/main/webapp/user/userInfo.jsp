        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="edit_info_form" action="${pageContext.request.contextPath }/loginPage" method="post">
    ...
    <div class="modal fade" id="pwdEditDialog" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="edit_pwd_form" action="${pageContext.request.contextPath }/loginPage" method="post">
                        <div class="form-group">
