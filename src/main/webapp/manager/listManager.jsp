...
<html xmlns="http://www.w3.org/1999/xhtml">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <c:forEach items="${list}" var="row">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick="editCustomer(${row.managerid})">修改</a>
                                            <a href="${pageContext.request.contextPath }/deleteManager" class="btn btn-danger btn-xs" onclick="deletePost('${row.managerid}')">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
        ...
        <div class="modal fade" id="customerEditDialog" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="${pageContext.request.contextPath }/updateManager" class="form-horizontal" id="edit_form" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input type="hidden" id="edit_id" name="managerid"/>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="edit_flag" style="float:left;padding:7px 15px 0 55px;">角色</label>
                                <div class="col-sm-10">
                                    <select	class="form-control" id="edit_flag" placeholder="角色" name="flag">
                                        <option value="">--请选择--</option>
                                        <option value="0" <c:if test="${type == '0'}"> selected</c:if>>
                                            普通管理员
                                        </option>
    ...
    <script type="text/javascript">
        ...
        function editCustomer(id) {
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath }/getManagerById",
                data:{"id":id},
                success:function(data) {
                    $("#edit_id").val(data.managerid);
